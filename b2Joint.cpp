...
b2Joint* b2Joint::Create(const b2JointDef* def, b2BlockAllocator* allocator)
{
    ...
    case e_elasticRope:
		{
			void* mem = allocator->Allocate(sizeof(b2ElasticRopeJoint));
			joint = new (mem) b2ElasticRopeJoint((b2ElasticRopeJointDef*)def);
		}
            break;
...
void b2Joint::Destroy(b2Joint* joint, b2BlockAllocator* allocator)
{
    ...
    case e_elasticRope:
            allocator->Free(joint, sizeof(b2ElasticRopeJoint));
            break;
